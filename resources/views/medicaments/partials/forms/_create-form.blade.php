@csrf
<div class="row">
    <div class="{{$title = 'Create new Medicament' ?? 'col-lg-5 col-12 text-black' ?? ''}}">
        <div class="ml-2 form-group">
            ...
            <div class="form-group mb-3">
                ...
                <input name="active_principle"
                       ...
                       value="{{old('active_principle') ?? $item->active_principle ?? '' }}" required/>
            ...
            <div class="form-group mb-3">
                ...
                <input name="grace_period_beef"
                       ...
                       value="{{old('grace_period_beef') ?? $item->grace_period_beef ?? '' }}" required/>
    ...
    <div class="{{$title = 'Create new Medicament' ?? 'col-lg-5 col-12 text-black' ?? ''}}">
        <div class="form-group mb-3">
            ...
            <input name="grace_period_dairy"
                   ...
                   value="{{old('grace_period_dairy') ?? $item->grace_period_dairy ?? '' }}" required/>
